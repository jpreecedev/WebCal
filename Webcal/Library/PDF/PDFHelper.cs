namespace Webcal.Library.PDF
{
    ...
    public static class PDFHelper
    {
        ...
        private static DialogHelperResult Save(bool saveToTempDirectory)
        {
            ...
            {
                string path = Path.Combine(DocumentHelper.GetTemporaryDirectory(), string.Format("document{0}.pdf", DateTime.Now.Ticks.ToString(CultureInfo.InvariantCulture).Substring(0, 5)));
